...
import { S as clsx, at as require_prop_types, dt as _extends, ft as init_extends, lt as _objectWithoutPropertiesLoose, m as composeClasses, t as styled, u as require_colorManipulator, ut as init_objectWithoutPropertiesLoose, x as generateUtilityClass } from "./styled-zgCQyHMB.js";
...
import { n as useTheme, t as getOverlayAlpha } from "./getOverlayAlpha-DGAYiXho.js";
...
var Paper = /* @__PURE__ */ import_react.forwardRef(function Paper(inProps, ref) {
	...
	if (useTheme().shadows[elevation] === void 0) console.error([`MUI: The elevation provided <Paper elevation={${elevation}}> is not available in the theme.`, `Please make sure that \`theme.shadows[${elevation}]\` is defined.`].join("\n"));
...
//#endregion
export { validator as i, getPaperUtilityClass as n, paperClasses as r, Paper as t };

//# sourceMappingURL=Paper-DeoC2yPp.js.map