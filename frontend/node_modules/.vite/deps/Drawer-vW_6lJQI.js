...
import { a as rootShouldForwardProp, ct as clsx, dt as init_extends, ft as _objectWithoutPropertiesLoose, i as styled, lt as require_prop_types, pt as init_objectWithoutPropertiesLoose, st as composeClasses, ut as _extends, v as generateUtilityClass, y as ClassNameGenerator } from "./DefaultPropsProvider-sylF6vtn.js";
import { t as require_react } from "./react.js";
import { t as require_jsx_runtime } from "./react_jsx-runtime.js";
import { t as useDefaultProps } from "./DefaultPropsProvider-Cy2HL1tb.js";
import { t as capitalize_default } from "./capitalize-CrjT2RwW.js";
import { i as validator, t as Paper } from "./Paper-CWkH-VK0.js";
import { t as chainPropTypes } from "./chainPropTypes-CkpaCYKB.js";
import { t as useTheme } from "./useTheme-CbIgzKzF.js";
import { b as useEnhancedEffect, c as exactProp, o as useRtl, s as useId } from "./esm-CDePz8vT.js";
import { t as generateUtilityClasses } from "./generateUtilityClasses-DcuI6LSJ.js";
import { n as isHostComponent } from "./isMuiElement-yt9bPV-0.js";
import { a as useForkRef_default, d as setRef, l as useForkRef, n as _inheritsLoose, t as TransitionGroupContext_default, u as useEventCallback } from "./TransitionGroupContext-B9paBO2L.js";
import { t as require_react_dom } from "./react-dom-Dq-84mgK.js";
...
function useSlotProps(parameters) {
	...
	const { elementType, externalSlotProps, ownerState, skipResolvingSlotProps = false } = parameters, rest = _objectWithoutPropertiesLoose(parameters, _excluded$6);
...
var Portal = /* @__PURE__ */ import_react.forwardRef(function Portal(props, forwardedRef) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_react.Fragment, { children: mountNode ? /* @__PURE__ */ import_react_dom.createPortal(children, mountNode) : mountNode });
});
Portal.propTypes = {
	/**
...
var Fade = /* @__PURE__ */ import_react.forwardRef(function Fade(props, ref) {
	...
	const { addEndListener, appear = true, children, easing, in: inProp, onEnter, onEntered, onEntering, onExit, onExited, onExiting, style, timeout = defaultTimeout, TransitionComponent = Transition } = props, other = _objectWithoutPropertiesLoose(props, _excluded$5);
...
var Backdrop = /* @__PURE__ */ import_react.forwardRef(function Backdrop(inProps, ref) {
	...
	const { children, className, component = "div", components = {}, componentsProps = {}, invisible = false, open, slotProps = {}, slots = {}, TransitionComponent = Fade, transitionDuration } = props, other = _objectWithoutPropertiesLoose(props, _excluded$4);
...
function useModal(parameters) {
	...
	const isTopModal = import_react.useCallback(() => manager.isTopModal(getModal()), [manager]);
...
var SvgIcon = /* @__PURE__ */ import_react.forwardRef(function SvgIcon(inProps, ref) {
	...
	const { children, className, color = "inherit", component = "svg", fontSize = "medium", htmlColor, inheritViewBox = false, titleAccess, viewBox = "0 0 24 24" } = props, other = _objectWithoutPropertiesLoose(props, _excluded$2);
...
var Slide = /* @__PURE__ */ import_react.forwardRef(function Slide(props, ref) {
	...
	const { addEndListener, appear = true, children, container: containerProp, direction = "down", easing: easingProp = defaultEasing, in: inProp, onEnter, onEntered, onEntering, onExit, onExited, onExiting, style, timeout = defaultTimeout, TransitionComponent = Transition } = props, other = _objectWithoutPropertiesLoose(props, _excluded$1);
...
init_objectWithoutPropertiesLoose();
init_extends();
var _excluded = ["BackdropProps"], _excluded2 = [
	"anchor",
	"BackdropProps",
	"children",
	"className",
...
//#endregion
export { reflow as A, appendOwnerState as B, getModalUtilityClass as C, getBackdropUtilityClass as D, backdropClasses as E, getReactElementRef as F, debounce as G, useControlled as H, useSlotProps as I, HTMLElementType as K, resolveComponentProps as L, FocusTrap as M, ModalManager as N, Fade as O, Transition as P, mergeSlotProps as R, Modal as S, Backdrop as T, ownerWindow as U, getScrollbarSize as V, ownerDocument as W, SvgIcon as _, getDrawerUtilityClass as a, createChainedFunction_default as b, useControlled_default as c, setRef_default as d, requirePropFactory_default as f, createSvgIcon as g, deprecatedPropType_default as h, drawerClasses as i, Portal as j, getTransitionProps as k, unsupportedProp_default as l, ownerDocument_default as m, getAnchor as n, Slide as o, ownerWindow_default as p, elementAcceptingRef as q, isHorizontal as r, unstable_ClassNameGenerator as s, Drawer as t, useId_default as u, getSvgIconUtilityClass as v, modalClasses as w, debounce_default as x, svgIconClasses as y, extractEventHandlers as z };

//# sourceMappingURL=Drawer-vW_6lJQI.js.map