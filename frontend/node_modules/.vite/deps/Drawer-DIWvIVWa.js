...
import { C as ClassNameGenerator, S as clsx, at as require_prop_types, dt as _extends, ft as init_extends, lt as _objectWithoutPropertiesLoose, m as composeClasses, n as rootShouldForwardProp, t as styled, ut as init_objectWithoutPropertiesLoose, x as generateUtilityClass } from "./styled-zgCQyHMB.js";
import { b as useEnhancedEffect, c as exactProp, o as useRtl, s as useId } from "./esm-up3-6aky.js";
import { t as generateUtilityClasses } from "./generateUtilityClasses-ErXtS9Dd.js";
import { t as chainPropTypes } from "./chainPropTypes-CiFUvyTO.js";
import { n as isHostComponent } from "./isMuiElement--1Ektg2m.js";
import { d as setRef, i as useForkRef_default, l as useForkRef, n as _inheritsLoose, t as TransitionGroupContext_default, u as useEventCallback } from "./TransitionGroupContext-DeTJgN16.js";
import { i as validator, t as Paper } from "./Paper-DeoC2yPp.js";
import { n as useTheme } from "./getOverlayAlpha-DGAYiXho.js";
import { t as capitalize_default } from "./capitalize-C4DrlM4i.js";
import { t as useDefaultProps } from "./DefaultPropsProvider-CEf2chPR.js";
...
var SvgIcon = /* @__PURE__ */ import_react.forwardRef(function SvgIcon(inProps, ref) {
	...
	const { children, className, color = "inherit", component = "svg", fontSize = "medium", htmlColor, inheritViewBox = false, titleAccess, viewBox = "0 0 24 24" } = props, other = _objectWithoutPropertiesLoose(props, _excluded$5);
...
var Fade = /* @__PURE__ */ import_react.forwardRef(function Fade(props, ref) {
	...
	const { addEndListener, appear = true, children, easing, in: inProp, onEnter, onEntered, onEntering, onExit, onExited, onExiting, style, timeout = defaultTimeout, TransitionComponent = Transition } = props, other = _objectWithoutPropertiesLoose(props, _excluded$4);
...
var Backdrop = /* @__PURE__ */ import_react.forwardRef(function Backdrop(inProps, ref) {
	...
	const { children, className, component = "div", components = {}, componentsProps = {}, invisible = false, open, slotProps = {}, slots = {}, TransitionComponent = Fade, transitionDuration } = props, other = _objectWithoutPropertiesLoose(props, _excluded$3);
	const ownerState = _extends({}, props, {
		component,
		invisible
	});
...
//#endregion
export { createSvgIcon as A, appendOwnerState as B, useId_default as C, ownerDocument_default as D, ownerWindow_default as E, getReactElementRef as F, debounce as G, useControlled as H, useSlotProps as I, HTMLElementType as K, resolveComponentProps as L, getSvgIconUtilityClass as M, svgIconClasses as N, deprecatedPropType_default as O, createChainedFunction_default as P, mergeSlotProps as R, unsupportedProp_default as S, requirePropFactory_default as T, ownerWindow as U, getScrollbarSize as V, ownerDocument as W, getTransitionProps as _, getDrawerUtilityClass as a, unstable_ClassNameGenerator as b, getModalUtilityClass as c, ModalManager as d, Backdrop as f, Portal as g, Fade as h, drawerClasses as i, SvgIcon as j, debounce_default as k, modalClasses as l, getBackdropUtilityClass as m, getAnchor as n, Slide as o, backdropClasses as p, elementAcceptingRef as q, isHorizontal as r, Modal as s, Drawer as t, FocusTrap as u, reflow as v, setRef_default as w, useControlled_default as x, Transition as y, extractEventHandlers as z };

//# sourceMappingURL=Drawer-DIWvIVWa.js.map